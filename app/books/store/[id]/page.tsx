...
import AddToCartModal from '@/component/book/AddToCartModal';
  ...
  return (
    <ShopLayout>
      <Box bg="linear-gradient(135deg, #0f172a 0%, #1a2332 50%, #0f172a 100%)" py={{ base: '60px', md: '80px' }} position="relative" overflow="hidden">
        {/* Background Elements */}
        {/* ... (keep existing setup but reduced indentation if possible, but tool handles content) */}
        {/* Actually, I will just paste the opening ShopLayout and keep the content inside, but I need to match valid chunks or replace the whole return to be safe. Replacing whole return is large. I will use a StartLine/EndLine replacer for the outer shell logic or just replace strict parts. */}
        {/* Actually, I will simply replace line 142 (return () => return <ShopLayout> ....) and line 426 (last </Box> ) to include closing </ShopLayout>. But they are separate chunks. */}
        {/* I'll replace the return statement start. */}

...
import { booksData } from '@/component/book/bookData';
...
export default function BookDetailPage() {
  ...
  const relatedBooks = booksData.filter((b) => b.program === book.program && b.id !== book.id).slice(0, 3);
          ...
          <MotionBox variants={itemVariants} initial="hidden" animate="visible" display="flex" flexDirection="column" justifyContent="center">
            ...
            <Box mb="24px">
              ...
              <Text fontSize="16px" color="#90CAF9" fontWeight="600">
                Save ₹{book.actualPrice - book.price} ({book.discount}% off)
              </Text>
            </Box>

            {/* Stock Status */}
            <Box mb="24px">
              <Text fontSize="16px" fontWeight="600" color={book.inStock ? '#90CAF9' : '#FF6B6B'}>
            ...
            <Box display="flex" gap="16px" mb="24px">
              <motion.button
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: '10px',
                  background: book.inStock ? 'linear-gradient(135deg, #FF8C00, #FFA500)' : 'rgba(100, 100, 100, 0.3)',
                  color: 'white',
            ...
            <motion.button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: '10px',
                background: book.inStock ? 'linear-gradient(135deg, #64B5F6, #42A5F5)' : 'rgba(100, 100, 100, 0.3)',
                color: 'white',
                cursor: book.inStock ? 'pointer' : 'not-allowed',
                transition: 'all 0.3s ease',
                opacity: book.inStock ? 1 : 0.6,
